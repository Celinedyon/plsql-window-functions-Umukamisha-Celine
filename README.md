...
![ROW_NUMBER Screenshot](ranking_row_number.png)
...
![RANK and DENSE_RANK Screenshot](ranking_rank_dense_rank.png)
...
![PERCENT_RANK Screenshot](ranking_percent_rank.png)
...
![SUM OVER Screenshot](aggregate_sum_running_totals.png)
...
![AVG OVER Screenshot](aggregate_avg_moving_averages.png)
...
![MIN MAX Screenshot](aggregate_min_max_analysis.png)
...
![LAG Growth Screenshot](navigation_lag_growth.png)
...
![LEAD Patterns Screenshot](navigation_lead_patterns.png)
...
![LAG LEAD Combined Screenshot](navigation_lag_lead_combined.png)
...
![NTILE Quartiles Screenshot](distribution_ntile_quartiles.png)
...
![CUME_DIST Screenshot](distribution_cume_dist_percentiles.png)
...
![Combined Distribution Screenshot](distribution_combined_analysis.png)
...
![Comprehensive Business Summary Screenshot](comprehensive_business_summary.png)
